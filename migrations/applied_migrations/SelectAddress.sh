...
echo "selectAddress.title = What is your address?" >> ../conf/messages.en
echo "selectAddress.heading = What is your address?" >> ../conf/messages.en
echo "selectAddress.address 1 = Address 2" >> ../conf/messages.en
echo "selectAddress.address 3 = Address 3" >> ../conf/messages.en
echo "selectAddress.checkYourAnswersLabel = What is your address?" >> ../conf/messages.en
