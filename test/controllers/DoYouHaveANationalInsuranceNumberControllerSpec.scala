...
class DoYouHaveANationalInsuranceNumberControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val doYouHaveANationalInsuranceNumberRoute = routes.DoYouHaveANationalInsuranceNumberController.onPageLoad(NormalMode).url
